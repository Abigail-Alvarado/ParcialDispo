...
void main() async {
  ...
  await Supabase.initialize(
    ...
    anonKey:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5hbGRwbWRremRxdHFiYXdhZGRmIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTU5NjIzMzEsImV4cCI6MjAxMTUzODMzMX0.eINagiA4yi1KzIKLMIhKYbuwzYZNoZBWykitfLbg6xc', //SUPABASE_ANON_KEY,
  );
  runApp(MainApp());
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  addData(String name, String title) {
    var response = Supabase.instance.client
        .from('tareas')
        .insert({'titulo': title, 'descripcion': name}).execute();
    print(response);
  }
